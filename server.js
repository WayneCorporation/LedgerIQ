...
async function api(req,res,url) {
  ...
  if(req.method==='PUT'&&url.pathname==='/api/profile'){
    ...
    const d=await body(req),companyName=clean(d.companyName,120),ownerName=clean(d.ownerName,120),userEmail=email(d.email),currency=clean(d.currency,3),templateId=clean(d.templateId,20)||'classic',accentColor=clean(d.accentColor,7)||'#5b5fef',font=clean(d.font,10)||'sans';
